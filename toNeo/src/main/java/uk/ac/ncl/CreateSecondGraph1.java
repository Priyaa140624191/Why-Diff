...
public class CreateSecondGraph1 {
	static List<String> entityNodes = CreateEntity2.getEntityIds();
	static List<String> activityNodes = CreateActivity2.getActivityIds();
	...
	private static List<Node> createEntityNodes() {
		...
		// Attributes for
		// tr-132084-BFF867C8-81FF-BAD2-4CEF-6F6DC6F0769A-imported-data
		propertyList
		...
		// Attributes for
		// tr-132084-DF7E5B8F-5986-A516-5A78-00F45AAD393D-filtered-data
		propertyList
		...
		// Attributes for
		// tr-132084-36ED8706-6AE1-83E0-97D8-EB10CD8080FC-imported-data
		propertyList
		...
		// Attributes for
		// tr-132084-C6D21A25-ED33-EB7E-5732-99603181330C-filtered-data
		propertyList
		...
		// Attributes for
		// tr-132084-03D691E5-0AF3-D9A4-C9D1-4E3AC66C7B90-output-1
		propertyList
		...
		propertyList
				.add("'esc:datatype':'data-wrapper','esc:hashvalue':'MTVoI7uy9QPtBcUyXzf4rA==','prov:type':['prov:Entity','provone:Document','esc:TransientData'],'recomp:datasize':13575."); // Attributes
		// tr-132084-633AC5C9-C332-56E0-D839-B89A4110B147-output-data
		propertyList
				.add("'esc:datatype':'data-wrapper','esc:hashvalue':'uxs6jJoGNk37hh8gRdn46A==','prov:type':['prov:Entity','provone:Document','esc:TransientData'],'recomp:datasize':13620."); // Attributes
		// Attributes for
		// tr-132084-58644E52-D670-0900-6105-0CD62F6E70C7-joined-data
		propertyList
				.add("'esc:datatype':'data-wrapper','esc:hashvalue':'e7ATkYBEHwF5a8fVeggzwg==','prov:type':['prov:Entity','provone:Document','esc:TransientData'],'recomp:datasize':453995."); // Attributes
	...
	private static List<Node> createActivityNodes() {
		...
		// Attributes for
		// "esc:svi-esc/invocation/132084/block/BFF867C8-81FF-BAD2-4CEF-6F6DC6F0769A");
		propertyList
				.add("'2017-03-13T16:26:19.436+0000','2017-03-13T16:26:35.577+0000',{'esc:dataConsumed':0,'esc:dataProduced':38516550,'prov:label':'CSVImport','prov:type':['prov:Activity','provone:Execution','esc:blockExecution']}.");

		// Attributes for
		// esc:svi-esc/invocation/132084/block/DF7E5B8F-5986-A516-5A78-00F45AAD393D
		propertyList
				.add("'2017-03-13T16:26:43.521+0000','2017-03-13T16:26:53.555+0000',{'esc:dataConsumed':38516550,'esc:dataProduced':19951170,'prov:label':'Where','prov:type':['prov:Activity','provone:Execution','esc:blockExecution']}.");
		// Attributes for
		// esc:svi-esc/invocation/132084/block/36ED8706-6AE1-83E0-97D8-EB10CD8080FC
		propertyList
		...
		// Attributes for
		// esc:svi-esc/invocation/132084/block/C6D21A25-ED33-EB7E-5732-99603181330C
		propertyList
		...
		// Attributes for
		// esc:svi-esc/invocation/132084/block/03D691E5-0AF3-D9A4-C9D1-4E3AC66C7B90
		propertyList
